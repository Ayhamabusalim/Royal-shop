    ...
    <div class="footer-middle container">
        <div class="row row-cols-lg-5 row-cols-2">
            <div class="footer-column footer-store-info col-12 mb-4 mb-lg-0">
                <div class="logo">
                    <a href="{{route('index')}}">
                        <img src="assets/images/logo2.png" alt="SurfsideMedia" class="logo__image d-block" />
                    </a>
                </div>
                <p class="footer-address">Amman , 7th Floor Al Sayegh Complex</p>
                <p class="m-0"><strong class="fw-medium">ayhamabuslem@gmail.coom</strong></p>
                <p><strong class="fw-medium">+962776756415</strong></p>
            ...
            <div class="footer-column footer-menu mb-4 mb-lg-0">
                ...
                <ul class="sub-menu__list list-unstyled">
                    <li class="sub-menu__item"><a href="{{route('about')}}" class="menu-link menu-link_us-s">About
                            Us</a></li>
                    <li class="sub-menu__item"><a href="{{route('contact')}}" class="menu-link menu-link_us-s">Contact
                            Us</a></li>
                </ul>
            </div>
