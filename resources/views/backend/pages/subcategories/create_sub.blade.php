                ...
                <div class="wg-box">
                    <form class="form-new-product form-style-1" action="{{route('subcategories.store')}}" method="POST"
                        ...
                        <fieldset class="name">
                            ...
                            <input class="flex-grow" type="text" placeholder="Sub Category name" name="name" tabindex="0"
                        ...
                        <fieldset class="name">
                            ...
                            <input class="flex-grow" type="text" placeholder="Sub Category Slug" name="slug" tabindex="0"
                                value="" aria-required="true" required="">
                        </fieldset>
                        <fieldset>
